...
public class ElGamalUtil {
    public static AsymmetricKeyParameter a(PublicKey publicKey) {
        if (publicKey instanceof ElGamalPublicKey) {
            ...
            return new ElGamalPublicKeyParameters(elGamalPublicKey.getY(), new ElGamalParameters(elGamalPublicKey.b().a(), elGamalPublicKey.b().b()));
    ...
    public static AsymmetricKeyParameter a(PrivateKey privateKey) {
        if (privateKey instanceof ElGamalPrivateKey) {
            ...
            return new ElGamalPrivateKeyParameters(elGamalPrivateKey.getX(), new ElGamalParameters(elGamalPrivateKey.b().a(), elGamalPrivateKey.b().b()));

...
public class AESEngine implements BlockCipher {
    ...
    private int[][] a(byte[] bArr, boolean z) {
        ...
        if ((length == 4 || length == 6 || length == 8) && length * 4 == bArr.length) {
            this.f = length + 6;
            int[][] iArr = (int[][]) Array.newInstance(Integer.TYPE, new int[]{this.f + 1, 4});
            int i = 0;
            int i2 = 0;
            while (i < bArr.length) {
    ...
    public void a(boolean z, CipherParameters cipherParameters) {
        if (cipherParameters instanceof KeyParameter) {
            this.g = a(((KeyParameter) cipherParameters).a(), z);
            this.l = z;
            return;
        }
    ...
    private void a(byte[] bArr, int i) {
        ...
        this.j = bArr[i3] & 255;
        i3 = i2 + 1;
        this.j = ((bArr[i2] & 255) << 8) | this.j;
        i4 = i3 + 1;
        this.j |= (bArr[i3] & 255) << 16;
        i3 = i4 + 1;
        this.j |= bArr[i4] << 24;
        i2 = i3 + 1;
        this.k = bArr[i3] & 255;
        i3 = i2 + 1;
        this.k = ((bArr[i2] & 255) << 8) | this.k;
        i4 = i3 + 1;
        this.k |= (bArr[i3] & 255) << 16;
        i3 = i4 + 1;
        this.k |= bArr[i4] << 24;
    }
    ...
    private void b(byte[] bArr, int i) {
        ...
        i2 = i3 + 1;
        bArr[i3] = (byte) (this.j >> 16);
        i3 = i2 + 1;
        bArr[i2] = (byte) (this.j >> 24);
        i2 = i3 + 1;
        bArr[i3] = (byte) this.k;
        i3 = i2 + 1;
        bArr[i2] = (byte) (this.k >> 8);
        i2 = i3 + 1;
        bArr[i3] = (byte) (this.k >> 16);
        i3 = i2 + 1;
        bArr[i2] = (byte) (this.k >> 24);
    }
    ...
    private void a(int[][] iArr) {
        ...
        int i2 = 1;
        while (i2 < this.f - 1) {
            a = (((d[this.h & 255] ^ a(d[(this.i >> 8) & 255], 24)) ^ a(d[(this.j >> 16) & 255], 16)) ^ a(d[(this.k >> 24) & 255], 8)) ^ iArr[i2][0];
            a2 = (((d[this.i & 255] ^ a(d[(this.j >> 8) & 255], 24)) ^ a(d[(this.k >> 16) & 255], 16)) ^ a(d[(this.h >> 24) & 255], 8)) ^ iArr[i2][1];
            a3 = (((d[this.j & 255] ^ a(d[(this.k >> 8) & 255], 24)) ^ a(d[(this.h >> 16) & 255], 16)) ^ a(d[(this.i >> 24) & 255], 8)) ^ iArr[i2][2];
            i = i2 + 1;
            i2 = iArr[i2][3] ^ (((d[this.k & 255] ^ a(d[(this.h >> 8) & 255], 24)) ^ a(d[(this.i >> 16) & 255], 16)) ^ a(d[(this.j >> 24) & 255], 8));
            this.h = (((d[a & 255] ^ a(d[(a2 >> 8) & 255], 24)) ^ a(d[(a3 >> 16) & 255], 16)) ^ a(d[(i2 >> 24) & 255], 8)) ^ iArr[i][0];
            this.i = (((d[a2 & 255] ^ a(d[(a3 >> 8) & 255], 24)) ^ a(d[(i2 >> 16) & 255], 16)) ^ a(d[(a >> 24) & 255], 8)) ^ iArr[i][1];
            this.j = (((d[a3 & 255] ^ a(d[(i2 >> 8) & 255], 24)) ^ a(d[(a >> 16) & 255], 16)) ^ a(d[(a2 >> 24) & 255], 8)) ^ iArr[i][2];
            a = a(d[(a3 >> 24) & 255], 8) ^ ((d[i2 & 255] ^ a(d[(a >> 8) & 255], 24)) ^ a(d[(a2 >> 16) & 255], 16));
            i2 = i + 1;
            this.k = a ^ iArr[i][3];
        }
        a = (((d[this.h & 255] ^ a(d[(this.i >> 8) & 255], 24)) ^ a(d[(this.j >> 16) & 255], 16)) ^ a(d[(this.k >> 24) & 255], 8)) ^ iArr[i2][0];
        ...
        i = i2 + 1;
        i2 = iArr[i2][3] ^ (((d[this.k & 255] ^ a(d[(this.h >> 8) & 255], 24)) ^ a(d[(this.i >> 16) & 255], 16)) ^ a(d[(this.j >> 24) & 255], 8));
        this.h = ((((a[a & 255] & 255) ^ ((a[(a2 >> 8) & 255] & 255) << 8)) ^ ((a[(a3 >> 16) & 255] & 255) << 16)) ^ (a[(i2 >> 24) & 255] << 24)) ^ iArr[i][0];
        this.i = iArr[i][1] ^ ((((a[a2 & 255] & 255) ^ ((a[(a3 >> 8) & 255] & 255) << 8)) ^ ((a[(i2 >> 16) & 255] & 255) << 16)) ^ (a[(a >> 24) & 255] << 24));
        this.j = ((((a[a3 & 255] & 255) ^ ((a[(i2 >> 8) & 255] & 255) << 8)) ^ ((a[(a >> 16) & 255] & 255) << 16)) ^ (a[(a2 >> 24) & 255] << 24)) ^ iArr[i][2];
        this.k = ((((a[i2 & 255] & 255) ^ ((a[(a >> 8) & 255] & 255) << 8)) ^ ((a[(a2 >> 16) & 255] & 255) << 16)) ^ (a[(a3 >> 24) & 255] << 24)) ^ iArr[i][3];
    }
    ...
    private void b(int[][] iArr) {
        ...
        int i = this.f - 1;
        while (i > 1) {
            a = (((e[this.h & 255] ^ a(e[(this.k >> 8) & 255], 24)) ^ a(e[(this.j >> 16) & 255], 16)) ^ a(e[(this.i >> 24) & 255], 8)) ^ iArr[i][0];
            a2 = (((e[this.i & 255] ^ a(e[(this.h >> 8) & 255], 24)) ^ a(e[(this.k >> 16) & 255], 16)) ^ a(e[(this.j >> 24) & 255], 8)) ^ iArr[i][1];
            a3 = (((e[this.j & 255] ^ a(e[(this.i >> 8) & 255], 24)) ^ a(e[(this.h >> 16) & 255], 16)) ^ a(e[(this.k >> 24) & 255], 8)) ^ iArr[i][2];
            int i2 = i - 1;
            i = iArr[i][3] ^ (((e[this.k & 255] ^ a(e[(this.j >> 8) & 255], 24)) ^ a(e[(this.i >> 16) & 255], 16)) ^ a(e[(this.h >> 24) & 255], 8));
            this.h = (((e[a & 255] ^ a(e[(i >> 8) & 255], 24)) ^ a(e[(a3 >> 16) & 255], 16)) ^ a(e[(a2 >> 24) & 255], 8)) ^ iArr[i2][0];
            this.i = (((e[a2 & 255] ^ a(e[(a >> 8) & 255], 24)) ^ a(e[(i >> 16) & 255], 16)) ^ a(e[(a3 >> 24) & 255], 8)) ^ iArr[i2][1];
            this.j = (((e[a3 & 255] ^ a(e[(a2 >> 8) & 255], 24)) ^ a(e[(a >> 16) & 255], 16)) ^ a(e[(i >> 24) & 255], 8)) ^ iArr[i2][2];
            a = a(e[(a >> 24) & 255], 8) ^ ((e[i & 255] ^ a(e[(a3 >> 8) & 255], 24)) ^ a(e[(a2 >> 16) & 255], 16));
            i = i2 - 1;
            this.k = a ^ iArr[i2][3];
        }
        a = (((e[this.h & 255] ^ a(e[(this.k >> 8) & 255], 24)) ^ a(e[(this.j >> 16) & 255], 16)) ^ a(e[(this.i >> 24) & 255], 8)) ^ iArr[i][0];
        ...
        a3 = (((e[this.j & 255] ^ a(e[(this.i >> 8) & 255], 24)) ^ a(e[(this.h >> 16) & 255], 16)) ^ a(e[(this.k >> 24) & 255], 8)) ^ iArr[i][2];
        i = iArr[i][3] ^ (((e[this.k & 255] ^ a(e[(this.j >> 8) & 255], 24)) ^ a(e[(this.i >> 16) & 255], 16)) ^ a(e[(this.h >> 24) & 255], 8));
        this.h = ((((b[a & 255] & 255) ^ ((b[(i >> 8) & 255] & 255) << 8)) ^ ((b[(a3 >> 16) & 255] & 255) << 16)) ^ (b[(a2 >> 24) & 255] << 24)) ^ iArr[0][0];
        this.i = ((((b[a2 & 255] & 255) ^ ((b[(a >> 8) & 255] & 255) << 8)) ^ ((b[(i >> 16) & 255] & 255) << 16)) ^ (b[(a3 >> 24) & 255] << 24)) ^ iArr[0][1];
        this.j = ((((b[a3 & 255] & 255) ^ ((b[(a2 >> 8) & 255] & 255) << 8)) ^ ((b[(a >> 16) & 255] & 255) << 16)) ^ (b[(i >> 24) & 255] << 24)) ^ iArr[0][2];
        this.k = ((((b[i & 255] & 255) ^ ((b[(a3 >> 8) & 255] & 255) << 8)) ^ ((b[(a2 >> 16) & 255] & 255) << 16)) ^ (b[(a >> 24) & 255] << 24)) ^ iArr[0][3];
    }
}

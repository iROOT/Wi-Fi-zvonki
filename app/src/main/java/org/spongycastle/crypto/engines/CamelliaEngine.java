...
public class CamelliaEngine implements BlockCipher {
    ...
    private void a(int[] iArr, int[] iArr2, int i) {
        ...
        i2 = h[(i2 >>> 24) & 255] ^ ((i[i2 & 255] ^ k[(i2 >>> 8) & 255]) ^ j[(i2 >>> 16) & 255]);
        int i3 = iArr[1] ^ iArr2[i + 1];
        i3 = j[(i3 >>> 24) & 255] ^ ((h[i3 & 255] ^ i[(i3 >>> 8) & 255]) ^ k[(i3 >>> 16) & 255]);
        iArr[2] = iArr[2] ^ (i2 ^ i3);
        iArr[3] = (a(i2, 8) ^ (i3 ^ i2)) ^ iArr[3];
        i2 = iArr[2] ^ iArr2[i + 2];
        i2 = h[(i2 >>> 24) & 255] ^ ((i[i2 & 255] ^ k[(i2 >>> 8) & 255]) ^ j[(i2 >>> 16) & 255]);
        i3 = iArr[3] ^ iArr2[i + 3];
        i3 = j[(i3 >>> 24) & 255] ^ ((h[i3 & 255] ^ i[(i3 >>> 8) & 255]) ^ k[(i3 >>> 16) & 255]);
        iArr[0] = iArr[0] ^ (i2 ^ i3);
        iArr[1] = (a(i2, 8) ^ (i3 ^ i2)) ^ iArr[1];
    }

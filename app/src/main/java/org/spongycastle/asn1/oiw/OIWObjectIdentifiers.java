...
public interface OIWObjectIdentifiers {
    public static final ASN1ObjectIdentifier a = new ASN1ObjectIdentifier("1.3.14.3.2.2");
    public static final ASN1ObjectIdentifier b = new ASN1ObjectIdentifier("1.3.14.3.2.3");
    public static final ASN1ObjectIdentifier c = new ASN1ObjectIdentifier("1.3.14.3.2.4");

 ...
 * either the {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#playTogether(Animator[]) playTogether()} or
 * {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#playSequentially(Animator[]) playSequentially()} methods can be called to add
 * a set of animations all at once, or the {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#play(Animator)} can be
 * used in conjunction with methods in the {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet.Builder Builder}
...
public final class AnimatorSet extends Animator {
     ...
     * com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#play(Animator) play()} method of <code>AnimatorSet</code> is to make it possible
     * to express the dependency relationships of animations in a natural way. Developers can also
     * use the {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#playTogether(Animator[]) playTogether()} and {@link
     * com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#playSequentially(Animator[]) playSequentially()} methods if these suit the need,
     * but it might be easier in some situations to express the AnimatorSet of animations in pairs.
     * <p/>
     * <p>The <code>Builder</code> object cannot be constructed directly, but is rather constructed
     * internally via a call to {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#play(Animator)}.</p>
     * <p/>
     ...
     * {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#play(Animator)} method that is the dependency in any of the successive
    ...
    public class Builder {
         ...
         * {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#play(Animator)} call that created this <code>Builder</code> object.
         *
         * @param anim The animation that will play when the animation supplied to the
         * {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#play(Animator)} method starts.
         */
         ...
         *
         * @param anim The animation that will play when the animation supplied to the
         * {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#play(Animator)} method ends.
         */
         ...
         * {@link com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet#play(Animator)} method to play.
         */

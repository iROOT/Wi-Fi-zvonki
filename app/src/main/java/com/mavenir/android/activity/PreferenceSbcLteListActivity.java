...
public class PreferenceSbcLteListActivity extends ActionBarActivity {
        ...
        if (bundle == null) {
            ...
            if (supportFragmentManager.findFragmentById(16908290) == null) {
                new Handler().post(new Runnable(this) {
                    final /* synthetic */ PreferenceSbcLteListActivity b;

                    public void run() {
                        supportFragmentManager.beginTransaction().add(16908290, h.a(a.LTE.ordinal())).commit();
                    }
                });
            }
        }
